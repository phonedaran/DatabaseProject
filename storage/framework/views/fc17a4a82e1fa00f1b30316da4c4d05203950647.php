...
<main role="main" style="background-color:LightGray;"><br>
  <div class="container col-md-8 bg-white"><br>
      ...
      <form class="needs-validation" method ="get" novalidate action="<?php echo e(URL::to('employee/add/check')); ?> ">
        ...
        <button class="btn btn-outline-primary btn-lg btn-block" type="submit">Submit</button><br>
...
</html><?php /**PATH C:\xampp\htdocs\DatabaseProject\resources\views/employees/addemployee.blade.php ENDPATH**/ ?>