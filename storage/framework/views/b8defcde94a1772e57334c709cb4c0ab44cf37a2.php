...
<!-- action="<?php echo e(URL::to('/productlist/detail')); ?>" -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <form  method="get">
                                                ...
                                                <button class="btn btn-outline-primary" onClick="this.form.action='<?php echo e(URL::to('/productlist/view')); ?>'; submit()" > View </button>
                                                <button class="btn btn-outline-primary" onClick="this.form.action='<?php echo e(URL::to('/UpdatePd')); ?>'; submit()" >Update</button>
