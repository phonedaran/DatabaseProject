...
<body>
    ...
    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <form action="customer/view" method="get">
        ...
        <div class="row"><div class="col" style="text-align :left;"><h2> <?php echo e($cus->customerName); ?></h2></div>
        <div class="col" style="text-align :right;"><h2><?php echo e($cus->point); ?></h2></div></div>
     </button></form>
     <div class="mb-2" ></div>
